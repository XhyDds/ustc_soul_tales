...
public class Player : MonoBehaviour
{
    ...
    //其他信息
    public static bool isgameovered;
    ...
    public IEnumerator save_wait()
    {
        ...
        else if(!Boss1.islive&&!isgameovered)
        {
          SaveFunction.instance.loadgame();
          isgameovered=true;
          SaveFunction.instance.savegame();
    ...
    public Save CreateSaveGameobject()
    {
        ...
        save.isnewgame=MainMenu.isnewgame;
        save.gameover=isgameovered;
        save.isboss1alive=Boss1.islive;
        save.isboss2alive=Boss2.islive;
    ...
    public void LoadSaveGameobject(Save save)
    {
        ...
        MainMenu.isnewgame=save.isnewgame;
        isgameovered=save.gameover;
        Debug.Log(Boss1.islive=save.isboss1alive);
        Debug.Log(Boss2.islive=save.isboss2alive);
