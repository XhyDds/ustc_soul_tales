...
public class EnemyGeneral : MonoBehaviour
{
    ...
    public GameObject barprefab;//前三个用于boss
    ...
    public void 击飞(float 距离,int 力量)
    {
        if(!isBoss)
        {
            if (距离 > 0)
            ...
            Vector3 forceDirection = new Vector3(距离 > 0 ? -力量 : 力量, 力量, 0);
